...
class ChromeDriverManager:
    ...
    def _get_chromedriver_auto(self) -> str:
        ...
        try:
            ...
            # webdriver-manager automatically finds and downloads the right version
            chromedriver_path = ChromeDriverManager().install()
            self.logger.info("✅ ChromeDriver auto-download successful")
